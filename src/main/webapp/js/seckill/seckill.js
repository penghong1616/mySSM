        ...
        $.ajax({
            ...
            success: function (pageInfo) {
                ...
                for (var i = 0; i < data.length; i++) {
                    $all_product.append("<div class='product_content_div' style='margin-left: 0%;width: 100%'>" +
                        "<div class='detail_product'>" +
                        ...
                        "<span class='detail_buy product_1' value='"+data[i].id+"'>去秒杀</span>" +
                        "</div>" +
                        "</div>");
                }
                <!--设置循环导航页-->
